...
<link rel="stylesheet" type="text/css" href="/KH_SecondPJ/CSS/lionlogin.css"/>
...
%>
     <form action="/KH_SecondPJ/MemberController" method="post" style="margin: 120px auto 0 auto">
    ...
    <script src="<%=request.getContextPath() %>/JS/lion.js"></script>
