...
<body>
	<%
		...
		String dateori = dto.getRdate().substring(0, 4) + "-" + dto.getRdate().substring(4, 6) + "-"
	...
	<div class="outer-container">
		...
		<div class="inner-container">
			<table border="0" style="border-collapse: collapse;">
				...
				<tr>
					<th>신청인</th>
					<td><input style="border: 0;" type="text" class="input_data"
				...
				<tr>
					<th>예정시간</th>
					<td><input style="border: 0;" type="text" class="input_data"
						name="date" value='<%=dateori%> <%=timeori%>시' readonly></td>
				</tr>

				<tr>
					<th>신청시간</th>
					<td><input style="border: 0;" type="text" class="input_data"
						name="date" value='<%=dto.getWdate().substring(0, 16)%>시'
						readonly></td>
				</tr>
				...
				<tr style="border-bottom: 0;">
					...
					<td style="padding-top: 8px;"><textarea class="input_data"
							rows="4" cols="50"
							style="width: 90%; height: 500px; outline: none" readonly><%=dto.getContent()%></textarea>
					</td>
				</tr>
		...
		<button class="mainbut" id="update" type="button"
			onclick="updatesch()">예약변경</button>
		<button class="mainbut" id="delete" type="button"
			onclick="deletesch()">예약취소</button>
		<button class="mainbut" type="button"
